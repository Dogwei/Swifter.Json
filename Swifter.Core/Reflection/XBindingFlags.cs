namespace Swifter.Reflection
{
    ...
    public enum XBindingFlags
    {
        ...
        /// 表示要包含继承的成员。
        /// </summary>
        InheritedMembers = 0x8000,
        /// <summary>
        /// XTypeInfo 创建时默认的标识。
        /// </summary>
        Default = Public | Instance | Field | Property | Indexer | Method | InheritedMembers | RWCannotGetException | RWCannotSetException | RWNotFoundException
    }
}