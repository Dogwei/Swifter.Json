...
namespace Swifter.Test
{
    ...
    class StructTest : ITestInfo
    {
        ...
        public bool VerDeser(object obj)
        {
            return obj is TestStruct @struct && @struct.Name == Name && @struct.Nullable is null && @struct.Count == Count;
        }
    ...
    unsafe class UnsafeTest : ITestInfo
    {
        ...
        public bool VerDeser(object obj)
        {
            return obj is UnsafeClass @struct && @struct.Name == Name && @struct.Pointer is null && @struct.Count == Count && (int)@struct.Address == Address;
        }
